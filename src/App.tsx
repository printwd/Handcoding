        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-2xl bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">초보탈출 손코딩</h3>
              </div>
              <p className="text-gray-400 leading-relaxed">
                하루 15분, 손으로 프로그램 완성하기. 💻<br/>
            ...
            >
              ...
              <ul className="space-y-3 text-gray-400">
                <motion.li whileHover={{ x: 5, color: "#fff" }} className="transition-all cursor-pointer">
                  📚 커리큘럼
                </motion.li>
                <motion.li whileHover={{ x: 5, color: "#fff" }} className="transition-all cursor-pointer">
                  🎮 무료 체험
            ...
            >
              ...
              <ul className="space-y-3 text-gray-400">
                <motion.li whileHover={{ scale: 1.05, color: "#fff" }} className="transition-all">
          ...
          >
            <div className="flex justify-center items-center gap-2 mb-3">
              ...
              <p className="text-gray-400">2025 손코딩랩. All rights reserved.</p>
            </div>
